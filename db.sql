...
CREATE TABLE `menu` (
  ...
  `rise` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '排序 数字越小排越前',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4;

/*Data for the table `menu` */

insert  into `menu`(`id`,`name`,`code`,`url`,`pid`,`status`,`is_action`,`rise`) values (1,'员工管理','staff','',0,0,0,1),(2,'员工列表','staff_list','staff/list',1,0,0,0),(3,'角色管理','role','',0,0,0,2),(4,'角色列表','role_list','role/list',3,0,0,0),(5,'员工列表 - 编辑','staff_edit','staff/edit',2,0,1,0),(6,'员工列表 - 删除','staff_delete','staff/delete',2,0,1,0),(7,'系统管理','system','',0,0,0,99),(8,'行政办公','office','',0,0,0,3),(9,'用品管理','office_supplies_list','office/supplies_list',8,0,0,0),(10,'培训管理','training','',0,0,0,4),(11,'培训课程','training_course','training/course_list',10,0,0,0),(12,'权限管理','system_auth','system/auth_list',7,0,0,0);
...
CREATE TABLE `office_supplies` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='办公用品表';

/*Data for the table `office_supplies` */

insert  into `office_supplies`(`id`,`name`,`desc`,`num`,`unit`,`created_at`,`updated_at`) values (1,'笔记本','ddadddda',1001,'本','2018-05-01 15:28:18','2018-05-19 20:49:03');
...
insert  into `role`(`id`,`name`,`menu_code`,`is_super`,`is_del`) values (1,'超级管理员','ALL',1,0),(2,'编辑','staff,staff_list',0,0),(3,'程序员','role_list',0,0),(4,'产品经理','staff,staff_list',0,0),(5,'老板','role,role_list,staff,staff_list,staff_delete,staff_edit',0,0),(6,'测试','role,role_list,staff_edit',0,0);
...
insert  into `user_role`(`id`,`userid`,`roleid`) values (1,1,1),(2,10,2),(3,7,5),(4,11,4),(5,6,3),(6,4,0),(7,12,0),(8,9,0),(9,13,0),(10,14,0),(11,15,0),(12,16,0),(13,17,0),(14,18,0),(15,19,0);
...
insert  into `users`(`id`,`username`,`nickname`,`password`,`salt`,`gender`,`avatar`,`is_freeze`,`login_ip`,`login_time`,`created_at`,`updated_at`) values (1,'admin','jxx','32c27a49109fc942e8fe153cacc09e54','30f4',0,'',0,'192.168.1.135','2018-05-01 10:22:18','2017-03-19 16:50:09','2018-05-01 10:22:18'),(2,'test','testtttt','','asdf',1,'',1,'','2017-03-19 16:50:09','2017-03-19 16:50:09','2017-09-09 08:47:46'),(3,'test2','test2','','56ew',1,'',0,'','2017-03-19 16:50:09','2017-03-19 16:50:09','2017-08-26 10:56:35'),(4,'ttttt','ttttt','cb7fdcf7ac4c6eec9cb641726e180771','asd5',2,'',1,'192.168.31.135','2017-06-11 17:59:35','2017-06-10 15:55:59','2018-05-01 10:23:18'),(5,'ttttt2','ttttt22222233